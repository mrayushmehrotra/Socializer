...
const Page = () => {
  ...
  const handleInput = async () => {
    ...
    const myData =  "Act as the Experienced High Click Rate Seo Friendly description writer and a youtuber who knows the youtube algorithm and give me the most suitable and most attractive description for wide range audience for this title (give me only Seo friendly description and nothing else): " 
