  ...
  const handleInput = async () => {
    ...
    try {
      const res = await axios.post("/api/gemini", {
        userInput:
          "Act as the Experienced SEO Expert and a youtuber hashtags expert who knows the youtube algorithm and give me the most suitable hashtags for this title (give me only hashtags and nothing else): " +
          data.userInput,
      });
