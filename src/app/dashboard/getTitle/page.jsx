  ...
  const handleInput = async () => {
    ...
    try {
      const res = await axios.post("/api/gemini", {
        userInput:
          "Act as the Experienced SEO Expert and a youtuber who knows the youtube algorithm and give me the most suitable and most attractive with wide range of audience for this title (give me only Seo friendly titles and nothing else): " +
          data.userInput,
      });
